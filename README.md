...
*ApplicationApi* | [**delete_workflow**](docs/ApplicationApi.md#delete_workflow) | **DELETE** /api/v1/applications/{appName}/workflows/{workflowName} | delete workflow
...
*ApplicationApi* | [**get_application_status_from_all_envs**](docs/ApplicationApi.md#get_application_status_from_all_envs) | **GET** /api/v1/applications/{appName}/status | get application status from all envs
...
*ApplicationApi* | [**list_workflow_records_from_env**](docs/ApplicationApi.md#list_workflow_records_from_env) | **GET** /api/v1/applications/{appName}/envs/{envName}/records | query application workflow execution record of one environment
...
*AuthenticationApi* | [**admin_configured**](docs/AuthenticationApi.md#admin_configured) | **GET** /api/v1/auth/admin_configured | check admin is configured
*AuthenticationApi* | [**configure_admin**](docs/AuthenticationApi.md#configure_admin) | **PUT** /api/v1/auth/init_admin | initialize admin
...
*OamApplicationApi* | [**delete_oam_application**](docs/OamApplicationApi.md#delete_oam_application) | **DELETE** /v1/namespaces/{namespace}/applications/{appname} | delete oam application in the specified namespace
...
*PluginApi* | [**detail_plugin**](docs/PluginApi.md#detail_plugin) | **GET** /api/v1/manage/plugins/{pluginId} | Detail an installed plugin
*PluginApi* | [**detail_plugin_0**](docs/PluginApi.md#detail_plugin_0) | **GET** /api/v1/plugins/{pluginId} | Detail an installed plugin
*PluginApi* | [**disable_plugin**](docs/PluginApi.md#disable_plugin) | **POST** /api/v1/manage/plugins/{pluginId}/disable | Disable an installed plugin
*PluginApi* | [**enable_plugin**](docs/PluginApi.md#enable_plugin) | **POST** /api/v1/manage/plugins/{pluginId}/enable | Enable an installed plugin
*PluginApi* | [**install_plugin**](docs/PluginApi.md#install_plugin) | **POST** /api/v1/manage/plugins/{pluginId}/install | Install one specific plugin
*PluginApi* | [**list_enabled_plugins**](docs/PluginApi.md#list_enabled_plugins) | **GET** /api/v1/plugins | List the enabled plugins
*PluginApi* | [**list_installed_plugins**](docs/PluginApi.md#list_installed_plugins) | **GET** /api/v1/manage/plugins | List the installed plugins
*PluginApi* | [**plugin_setting**](docs/PluginApi.md#plugin_setting) | **POST** /api/v1/manage/plugins/{pluginId}/setting | Set an installed plugin
*PluginApi* | [**uninstall_plugin**](docs/PluginApi.md#uninstall_plugin) | **POST** /api/v1/manage/plugins/{pluginId}/uninstall | Uninstall one specific plugin
...
*TargetApi* | [**delete_target**](docs/TargetApi.md#delete_target) | **DELETE** /api/v1/targets/{targetName} | delete Target
...
## Documentation For Models
 ...
 - [CommonPeriodHttpOption](docs/CommonPeriodHttpOption.md)
 ...
 - [TypesPeriodBuildInfo](docs/TypesPeriodBuildInfo.md)
 - [TypesPeriodHeader](docs/TypesPeriodHeader.md)
 - [TypesPeriodIncludes](docs/TypesPeriodIncludes.md)
 - [TypesPeriodInfo](docs/TypesPeriodInfo.md)
 - [TypesPeriodInfoLink](docs/TypesPeriodInfoLink.md)
 - [TypesPeriodJsonData](docs/TypesPeriodJsonData.md)
 - [TypesPeriodKubernetesSecret](docs/TypesPeriodKubernetesSecret.md)
 - [TypesPeriodKubernetesService](docs/TypesPeriodKubernetesService.md)
 - [TypesPeriodLogos](docs/TypesPeriodLogos.md)
 - [TypesPeriodNamespacedName](docs/TypesPeriodNamespacedName.md)
 - [TypesPeriodPermission](docs/TypesPeriodPermission.md)
 - [TypesPeriodReference](docs/TypesPeriodReference.md)
 - [TypesPeriodRequirement](docs/TypesPeriodRequirement.md)
 - [TypesPeriodRoute](docs/TypesPeriodRoute.md)
 - [TypesPeriodScreenshots](docs/TypesPeriodScreenshots.md)
 - [TypesPeriodSecretReference](docs/TypesPeriodSecretReference.md)
 - [TypesPeriodWorkspace](docs/TypesPeriodWorkspace.md)
 ...
 - [V1PeriodAdminConfiguredResponse](docs/V1PeriodAdminConfiguredResponse.md)
 ...
 - [V1PeriodApplicationStatusListResponse](docs/V1PeriodApplicationStatusListResponse.md)
 ...
 - [V1PeriodInitAdminRequest](docs/V1PeriodInitAdminRequest.md)
 - [V1PeriodInitAdminResponse](docs/V1PeriodInitAdminResponse.md)
 - [V1PeriodInputVar](docs/V1PeriodInputVar.md)
 - [V1PeriodInstallPluginRequest](docs/V1PeriodInstallPluginRequest.md)
 ...
 - [V1PeriodListPluginResponse](docs/V1PeriodListPluginResponse.md)
 ...
 - [V1PeriodManagedPluginDto](docs/V1PeriodManagedPluginDto.md)
 ...
 - [V1PeriodPluginDto](docs/V1PeriodPluginDto.md)
 - [V1PeriodPluginEnableRequest](docs/V1PeriodPluginEnableRequest.md)
 - [V1PeriodPolicyBase](docs/V1PeriodPolicyBase.md)
 - [V1PeriodPolicyRule](docs/V1PeriodPolicyRule.md)
 ...
 - [V1PeriodUserProjectBase](docs/V1PeriodUserProjectBase.md)
