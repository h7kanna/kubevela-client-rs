...
/// struct for typed errors of method [`get_application_status_from_all_envs`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetApplicationStatusFromAllEnvsError {
    Status400(crate::models::BcodePeriodBcode),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`list_workflow_records_from_env`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListWorkflowRecordsFromEnvError {
    Status500(),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_or_update_application_workflow(configuration: &configuration::Configuration, app_name: &str, body: crate::models::V1PeriodCreateWorkflowRequest) -> Result<crate::models::V1PeriodDetailWorkflowResponse, Error<CreateOrUpdateApplicationWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn detail_workflow(configuration: &configuration::Configuration, app_name: &str, workflow_name: &str) -> Result<crate::models::V1PeriodDetailWorkflowResponse, Error<DetailWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn detail_workflow_record(configuration: &configuration::Configuration, app_name: &str, workflow_name: &str, record: &str) -> Result<crate::models::V1PeriodDetailWorkflowRecordResponse, Error<DetailWorkflowRecordError>> {
    let local_var_configuration = configuration;
...
pub async fn get_application_status_from_all_envs(configuration: &configuration::Configuration, app_name: &str) -> Result<crate::models::V1PeriodApplicationStatusListResponse, Error<GetApplicationStatusFromAllEnvsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/applications/{appName}/status", local_var_configuration.base_path, appName=crate::apis::urlencode(app_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetApplicationStatusFromAllEnvsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_application_workflows(configuration: &configuration::Configuration, app_name: &str) -> Result<crate::models::V1PeriodListWorkflowResponse, Error<ListApplicationWorkflowsError>> {
    let local_var_configuration = configuration;
...
pub async fn list_workflow_records(configuration: &configuration::Configuration, app_name: &str, workflow_name: &str, page: Option<i32>, page_size: Option<i32>) -> Result<crate::models::V1PeriodListWorkflowRecordsResponse, Error<ListWorkflowRecordsError>> {
    let local_var_configuration = configuration;
...
pub async fn list_workflow_records_from_env(configuration: &configuration::Configuration, app_name: &str, env_name: &str, page: Option<i32>, page_size: Option<i32>) -> Result<crate::models::V1PeriodListWorkflowRecordsResponse, Error<ListWorkflowRecordsFromEnvError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/applications/{appName}/envs/{envName}/records", local_var_configuration.base_path, appName=crate::apis::urlencode(app_name), envName=crate::apis::urlencode(env_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListWorkflowRecordsFromEnvError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_workflow(configuration: &configuration::Configuration, app_name: &str, workflow_name: &str, body: crate::models::V1PeriodUpdateWorkflowRequest) -> Result<crate::models::V1PeriodDetailWorkflowResponse, Error<UpdateWorkflowError>> {
    let local_var_configuration = configuration;
