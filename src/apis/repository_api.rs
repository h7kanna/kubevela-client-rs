...
pub async fn chart_values(configuration: &configuration::Configuration, chart: &str, version: &str, repo_url: &str, repo_type: &str, secret_name: Option<&str>) -> Result<String, Error<ChartValuesError>> {
...
pub async fn get_chart_values(configuration: &configuration::Configuration, chart: &str, version: &str, repo_url: Option<&str>, secret_name: Option<&str>) -> Result<serde_json::Value, Error<GetChartValuesError>> {
    let local_var_configuration = configuration;
...
pub async fn list_chart_versions(configuration: &configuration::Configuration, chart: &str, repo_url: Option<&str>, secret_name: Option<&str>) -> Result<crate::models::V1PeriodChartVersionListResponse, Error<ListChartVersionsError>> {
    let local_var_configuration = configuration;
...
pub async fn list_charts(configuration: &configuration::Configuration, repo_url: Option<&str>, secret_name: Option<&str>) -> Result<Vec<String>, Error<ListChartsError>> {
    let local_var_configuration = configuration;
...
pub async fn list_versions_from_query(configuration: &configuration::Configuration, chart: &str, repo_url: &str, secret_name: Option<&str>) -> Result<crate::models::V1PeriodChartVersionListResponse, Error<ListVersionsFromQueryError>> {
    let local_var_configuration = configuration;
