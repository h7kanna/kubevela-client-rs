...
impl V1PeriodDetailDefinitionResponse {
    pub fn new(alias: String, category: String, description: String, icon: String, labels: ::std::collections::HashMap<String, String>, name: String, owner_addon: String, schema: String, status: String, ui_schema: Vec<crate::models::SchemaPeriodUiParameter>) -> V1PeriodDetailDefinitionResponse {
