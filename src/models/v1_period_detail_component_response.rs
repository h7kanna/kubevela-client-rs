...
pub struct V1PeriodDetailComponentResponse {
    #[serde(rename = "alias")]
    pub alias: String,
    ...
    pub definition: Box<crate::models::V1beta1PeriodComponentDefinitionSpec>,
...
impl V1PeriodDetailComponentResponse {
    pub fn new(alias: String, app_primary_key: String, create_time: String, creator: String, definition: crate::models::V1beta1PeriodComponentDefinitionSpec, main: bool, name: String, r#type: String, update_time: String) -> V1PeriodDetailComponentResponse {
