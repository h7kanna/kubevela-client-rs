...
impl V1PeriodDefinitionBase {
    pub fn new(alias: String, category: String, description: String, icon: String, labels: ::std::collections::HashMap<String, String>, name: String, owner_addon: String, status: String) -> V1PeriodDefinitionBase {
