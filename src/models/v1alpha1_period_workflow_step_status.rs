...
pub struct V1alpha1PeriodWorkflowStepStatus {
    ...
    pub sub_steps: Option<Vec<crate::models::V1alpha1PeriodStepStatus>>,
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
}

impl V1alpha1PeriodWorkflowStepStatus {
    pub fn new(id: String) -> V1alpha1PeriodWorkflowStepStatus {
