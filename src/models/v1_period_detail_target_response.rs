...
pub struct V1PeriodDetailTargetResponse {
...
impl V1PeriodDetailTargetResponse {
    pub fn new(create_time: String, name: String, project: crate::models::V1PeriodNameAlias, update_time: String) -> V1PeriodDetailTargetResponse {
        V1PeriodDetailTargetResponse {
            alias: None,
            app_num: None,
            cluster: None,
            cluster_alias: None,
